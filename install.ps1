...
#
# 离线/手动下载场景:
#   .\install.ps1 -LocalFile 'C:\Users\$env:USERNAME\Downloads\chimela-windows-x86_64.exe' -Version v2.28.2-omega
#
...
#
# 参数说明:
#   -Version <ver>      指定版本 (默认: latest,如 v2.28.2-omega)
...
可能原因与解决方案:
  ...
  2) 企业防火墙/DPI 阻断 → 使用 -Proxy 参数,或先手动下载后用 -LocalFile 安装
     ...
     示例: .\install.ps1 -LocalFile 'C:\Users\$env:USERNAME\Downloads\chimela-windows-x86_64.exe' -Version v2.28.2-omega
