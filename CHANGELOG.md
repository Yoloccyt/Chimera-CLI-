...
## [1.5.8-omega] - 2026-07-13

### Summary

v1.5.8-omega 是 v1.5.7-omega 的 GA 后演进 patch 版本,聚焦版本号一致性同步与发布工程文档对齐。本次迭代以版本号升级、用户侧品牌名及多平台分发模板更新为主,无功能性代码变更,保持 release 文档、安装脚本、CI/CD 产物与 `workspace.package.version` 完全一致。

### Changed

- `Cargo.toml` `[workspace.package].version` 从 `1.5.7-omega` 更新为 `1.5.8-omega`
- 统一用户侧品牌名为 `chimela cli`,保留 `chimera`/`aether` 兼容别名
...
- 修正 README、Dockerfile、安装脚本、packaging 与 CI 中残留的 `1.5.3`–`1.5.7` 版本引用,统一为 `1.5.8-omega`
