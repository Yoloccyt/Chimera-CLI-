...
v1.5.7-omega 是 v1.5.6-omega 的 GA 后演进 patch 版本,聚焦 QA 改进项落地与项目配置一致性同步。本次迭代以文档与发布工程一致性修复为主,涉及版本号、用户侧品牌名及多平台分发模板。无功能性代码变更,主要为 flaky test 隔离加固、规则文档同步、脚本编码合规修复。
...
- 修正 README、Dockerfile、安装脚本、packaging 与 CI 中残留的 `1.5.3`–`1.5.6` 版本引用,统一为 `1.5.7-omega`
