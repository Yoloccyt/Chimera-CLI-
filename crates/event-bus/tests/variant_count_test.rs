...
fn variant_ordinals(event: &NexusEvent) -> u32 {
    match event {
        ...
        NexusEvent::FormalVerificationFailed { .. } => 15,
        NexusEvent::BudgetExceeded { .. } => 16,
        NexusEvent::SandboxViolation { .. } => 17,
        NexusEvent::OperationProduced { .. } => 18,
        NexusEvent::PredictionVerified { .. } => 19,
        NexusEvent::OmniSparseMasksComputed { .. } => 20,
        NexusEvent::ToolsRouted { .. } => 21,
        NexusEvent::ExecutionCompleted { .. } => 22,
        NexusEvent::MemoryMetricsReported { .. } => 23,
        NexusEvent::MemoryTiered { .. } => 24,
        NexusEvent::CacheHit { .. } => 25,
        NexusEvent::CacheMiss { .. } => 26,
        NexusEvent::WikiUpdated { .. } => 27,
        NexusEvent::EvolutionTriggered { .. } => 28,
        NexusEvent::DpoPairGenerated { .. } => 29,
        NexusEvent::AuditLogged { .. } => 30,
        NexusEvent::McpMessageReceived { .. } => 31,
        NexusEvent::SlowConsumerDropped { .. } => 32,
        NexusEvent::ContextWindowSwitched { .. } => 33,
        NexusEvent::ContextCompressed { .. } => 34,
        NexusEvent::CapabilityTiered { .. } => 35,
        NexusEvent::CapabilityTierStatsReported { .. } => 36,
        NexusEvent::BlocksRebalanced { .. } => 37,
        NexusEvent::ExpertActivated { .. } => 38,
        NexusEvent::ActivationThresholdAdjusted { .. } => 39,
        NexusEvent::ActivationCacheStats { .. } => 40,
        NexusEvent::GatherCompleted { .. } => 41,
        NexusEvent::OperationTimedOut { .. } => 42,
        NexusEvent::GatherTimedOut { .. } => 43,
        NexusEvent::OrphanCallDetected { .. } => 44,
        NexusEvent::ProducerStrategyAdjusted { .. } => 45,
        NexusEvent::PredictionMade { .. } => 46,
        NexusEvent::PredictionStatsReported { .. } => 47,
        NexusEvent::PredictionRolledBack { .. } => 48,
        NexusEvent::CachePrefetched { .. } => 49,
        NexusEvent::CacheStatsReported { .. } => 50,
        NexusEvent::ExpertRouted { .. } => 51,
        NexusEvent::EntropyBalanced { .. } => 52,
        NexusEvent::ExpertRegistered { .. } => 53,
        NexusEvent::ExpertUnregistered { .. } => 54,
        NexusEvent::DebateStarted { .. } => 55,
        NexusEvent::SkepticVeto { .. } => 56,
        NexusEvent::VetoOverridden { .. } => 57,
        NexusEvent::RedTeamAudit { .. } => 58,
        NexusEvent::BudgetAdjusted { .. } => 59,
        NexusEvent::AsaIntervention { .. } => 60,
        NexusEvent::AhirtProbeCompleted { .. } => 61,
        NexusEvent::RoleRegistered { .. } => 62,
        NexusEvent::BudgetStatsReported { .. } => 63,
        NexusEvent::BudgetMetricsUpdated { .. } => 64,
        NexusEvent::NmcEncoded { .. } => 65,
        NexusEvent::ChtcToolCallReceived { .. } => 66,
        NexusEvent::SsraFusionCompleted { .. } => 67,
        NexusEvent::GsoePolicyUpdated { .. } => 68,
        NexusEvent::LsctTierSwitched { .. } => 69,
        NexusEvent::McpMeshTransactionCompleted { .. } => 70,
        NexusEvent::CsnSubstitutionTriggered { .. } => 71,
        NexusEvent::SesaActivationCompleted { .. } => 72,
        NexusEvent::EfficiencyAlertTriggered { .. } => 73,
        NexusEvent::QuestPauseRequested { .. } => 74,
        NexusEvent::QuestResumeRequested { .. } => 75,
        NexusEvent::VoteCastRequested { .. } => 76,
        NexusEvent::RefreshStateRequested { .. } => 77,
        NexusEvent::QuestPaused { .. } => 78,
        NexusEvent::QuestResumed { .. } => 79,
        NexusEvent::QuestCancelRequested { .. } => 80,
        NexusEvent::QuestCancelled { .. } => 81,
        NexusEvent::QuestPriorityChanged { .. } => 82,
        NexusEvent::QuestPriorityAdjusted { .. } => 83,
        NexusEvent::DecayMetricsReported { .. } => 84,
        NexusEvent::RouterStatsReported { .. } => 85,
        NexusEvent::McpNodeHeartbeat { .. } => 86,
        NexusEvent::ChtcAdapterStatus { .. } => 87,
        NexusEvent::ClvSnapshotReported { .. } => 88,
        NexusEvent::AgentTaskDelegated { .. } => 89,
        NexusEvent::AgentTaskCompleted { .. } => 90,
        NexusEvent::AgentTaskFailed { .. } => 91,
        NexusEvent::AgentConsultRequested { .. } => 92,
        NexusEvent::AgentConsultResponded { .. } => 93,
        NexusEvent::AgentHeartbeat { .. } => 94,
        NexusEvent::AgentContextOverflow { .. } => 95,
        NexusEvent::TuiActionRequested { .. } => 96,
        NexusEvent::TuiActionProgressed { .. } => 97,
        NexusEvent::TuiActionCompleted { .. } => 98,
        NexusEvent::TuiActionFailed { .. } => 99,
        NexusEvent::TuiChatSubmitted { .. } => 100,
        NexusEvent::TuiChatResponseChunk { .. } => 101,
        NexusEvent::TuiChatCompleted { .. } => 102,
        NexusEvent::TuiChatStatusChanged { .. } => 103,
        NexusEvent::TuiChatHistoryReplaced { .. } => 104,
        NexusEvent::TuiHello { .. } => 105,
        NexusEvent::TuiHelloAck { .. } => 106,
        NexusEvent::R1ShadowRegressionDetected { .. } => 107,
        NexusEvent::R1ShadowPromotionReady { .. } => 108,
        NexusEvent::R1ShadowRollbackFailed { .. } => 109,
        NexusEvent::SpecRegistered { .. } => 110,
        NexusEvent::R2FreezeViolation { .. } => 111,
        NexusEvent::R2FreezeRollbackFailed { .. } => 112,
        NexusEvent::CoordinationRatioReported { .. } => 113,
        NexusEvent::AuditFindingRaised { .. } => 114,
        NexusEvent::HarnessReportGenerated { .. } => 115,
        NexusEvent::DebateCompleted { .. } => 116,
        NexusEvent::DelegationCompleted { .. } => 117,
        NexusEvent::ParliamentStrategyCapChanged { .. } => 118,
        NexusEvent::ModelAffinitySelected { .. } => 119,
        NexusEvent::CrossVendorNegotiation { .. } => 120,
        NexusEvent::ProviderDegraded { .. } => 121,
        NexusEvent::AffinityCapabilityNegotiated { .. } => 122,
        NexusEvent::AffinityQuotaExhausted { .. } => 123,
        NexusEvent::AffinityUnknownField { .. } => 124,
        NexusEvent::StreamSessionCompleted { .. } => 125,
        NexusEvent::WindowAffinityApplied { .. } => 126,
        NexusEvent::CacheAffinityApplied { .. } => 127,
        NexusEvent::ContextBudgetAllocated { .. } => 128,
        NexusEvent::SemanticCacheHit { .. } => 129,
        NexusEvent::GhostMemoryDetected { .. } => 130,
        NexusEvent::MemConStrategyAdjusted { .. } => 131,
        NexusEvent::BenchmarkMetricsCollected { .. } => 132,
        NexusEvent::HcwRecallReported { .. } => 133,
        NexusEvent::HcwRecallDegraded { .. } => 134,
        NexusEvent::OverWindowFallbackTriggered { .. } => 135,
        NexusEvent::ResourceRecovered { .. } => 136,
        NexusEvent::FormalViolation { .. } => 137,
        NexusEvent::RewardSignalReported { .. } => 138,
        NexusEvent::StopRulingIssued { .. } => 139,
        NexusEvent::VariantApproved { .. } => 140,
        NexusEvent::ParentSelected { .. } => 141,
        NexusEvent::ErrorSignatureMatched { .. } => 142,
        NexusEvent::TokenLedgerRecorded { .. } => 143,
        NexusEvent::AssessmentUpdated { .. } => 144,
        NexusEvent::BusThroughputReported { .. } => 145,
        NexusEvent::SecurityInterceptionReported { .. } => 146,
    }
}
