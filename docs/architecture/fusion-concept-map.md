...
> - **权威基线**：v2.28.0-omega · **43 crates**（28 生产可达 + 15 ADR-160 冻结孤岛）· **144 NexusEvent**（`event-bus/src/types.rs` 单表）· **ADR-160 可达性棘轮**。测试数**以实测为准**（工作区全量重测登记 11564 passed / 0 failed，2026-08-31）。
