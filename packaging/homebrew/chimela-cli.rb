class ChimelaCli < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Yoloccyt/Chimera-CLI-/releases/download/v1.5.7-omega/chimela-macos-aarch64"
    sha256 "PLACEHOLDER_SHA256_MACOS_AARCH64"
  elsif OS.mac? && Hardware::CPU.intel?
    url "https://github.com/Yoloccyt/Chimera-CLI-/releases/download/v1.5.7-omega/chimela-macos-x86_64"
    sha256 "PLACEHOLDER_SHA256_MACOS_X86_64"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Yoloccyt/Chimera-CLI-/releases/download/v1.5.7-omega/chimela-linux-x86_64"
