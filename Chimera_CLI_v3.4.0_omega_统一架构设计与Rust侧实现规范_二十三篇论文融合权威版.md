...
> - **基线已演进**:本文档 §头部"基线实证 v2.27.1 / 38 crates / 10836 / 86 ADR"为撰写时点值;截至 2026-09-06：v2.28.0-omega 发布提交 af62e44 已落(tag 待推) · 43 crates(28 生产可达/14 冻结孤岛 + 1 GATED，ADR-177) · 144 事件(types.rs 单表) · 11587 tests(2026-09-02 重测) · ADR 主编号至 182。
